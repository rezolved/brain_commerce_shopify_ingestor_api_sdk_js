...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrainCommerceShopifyIngestorApi.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new BrainCommerceShopifyIngestorApi.ValidationError();
      //expect(instance).to.be.a(BrainCommerceShopifyIngestorApi.ValidationError);
    });
