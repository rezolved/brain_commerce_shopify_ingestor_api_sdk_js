...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrainCommerceShopifyIngestorApi.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new BrainCommerceShopifyIngestorApi.ValidationErrorLocInner();
      //expect(instance).to.be.a(BrainCommerceShopifyIngestorApi.ValidationErrorLocInner);
    });
