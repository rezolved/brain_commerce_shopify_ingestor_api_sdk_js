...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrainCommerceShopifyIngestorApi.ResponseGetFullProductIngestionQueue();
  });
  ...
  describe('ResponseGetFullProductIngestionQueue', function() {
    it('should create an instance of ResponseGetFullProductIngestionQueue', function() {
      // uncomment below and update the code to test ResponseGetFullProductIngestionQueue
      //var instance = new BrainCommerceShopifyIngestorApi.ResponseGetFullProductIngestionQueue();
      //expect(instance).to.be.a(BrainCommerceShopifyIngestorApi.ResponseGetFullProductIngestionQueue);
    });
