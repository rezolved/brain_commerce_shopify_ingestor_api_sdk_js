...
(function(root, factory) {
  ...
  describe('ProductAvailability', function() {
    it('should create an instance of ProductAvailability', function() {
      // uncomment below and update the code to test ProductAvailability
      //var instance = new BrainCommerceShopifyIngestorApi.ProductAvailability();
      //expect(instance).to.be.a(BrainCommerceShopifyIngestorApi.ProductAvailability);
    });
