...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BrainCommerceShopifyIngestorApi.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new BrainCommerceShopifyIngestorApi.HTTPValidationError();
      //expect(instance).to.be.a(BrainCommerceShopifyIngestorApi.HTTPValidationError);
    });
